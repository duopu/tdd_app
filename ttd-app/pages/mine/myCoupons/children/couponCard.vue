<template>
	<view class="coupon-card">
		...
		<view class="c-card1">
			<view class="c-card1-money">{{ coupon.couponNature == '3' ? `${coupon.discount}折` : coupon.parvalue / 100 }}
			</view>
		...
		<view class="c-card2">
			<view class="c-card21">
				<view class="c-card24" :class="coupon.couponNature == '2' ? 'c-card24-red' : ''">
					{{ couponType(coupon.couponNature) }}</view>
			...
			<view>
				<view class="c-card23">
					...
					<uni-icons :type="spread ? 'arrowup' : 'arrowdown'" color="#BDBDBD" size="12"
						@click="changeSpread" />
				</view>
		...
		<!--未选中-->
		<uni-icons v-if="minusType == 2" type="circle" class="c-card5" size="28" color="#BDBDBD"
			@click="$emit('useCoupon', coupon)" />

		<!-- 选中 -->
		<uni-icons v-if="minusType == 3" type="circle-filled" class="c-card5" size="28" color="#3D49AB"
			@click="$emit('useCoupon', coupon)" />
