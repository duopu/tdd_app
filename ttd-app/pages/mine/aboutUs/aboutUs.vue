	...
	<view>
		...
		<back-container>
			...
			<view class="about-us">
				...
				<view class="list-box border-top">
					<view class="list-item-cc" v-for="agreement in agreementList" :key="agreement.title" @click="navAgreement(agreement.title)">
						<image class="list-item-img" src="https://ttd-public.obs.cn-east-3.myhuaweicloud.com/app-img/icon/agreement.png" />
						<view class="list-item-right">
							<view class="list-title flex-1">{{agreement.title }}</view>
							<image src="https://ttd-public.obs.cn-east-3.myhuaweicloud.com/app-img/icon/grady-right-arrow.png" class="left-arrow"></image>
						</view>
					</view>
				</view> 
