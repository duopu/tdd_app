<template>
  <view>
    <view class="wheel_wp sol-class">
      <block v-if="mode == 1">
        <image src="https://ttd-public.obs.cn-east-3.myhuaweicloud.com/app-img/mine/s-dial_bg.png"></image>
        <view class="wheel_pointer" @tap="start"
          ...
          <image src="https://ttd-public.obs.cn-east-3.myhuaweicloud.com/app-img/mine/s-dial_pointer.png"></image>
        </view>
      </block>
      <block v-if="mode == 2">
        <image src="https://ttd-public.obs.cn-east-3.myhuaweicloud.com/app-img/mine/s-dial_bg.png"
               :style="'-webkit-transform:rotate(' + deg + 'deg) translateZ(0);transform:rotate(' + deg + 'deg) translateZ(0)'"></image>
        <view class="wheel_pointer" @tap="start">
          <image src="https://ttd-public.obs.cn-east-3.myhuaweicloud.com/app-img/mine/s-dial_pointer.png"></image>
        </view>
      </block>
...
<script>
// 插件地址 https://ext.dcloud.net.cn/plugin?id=2741#detail
